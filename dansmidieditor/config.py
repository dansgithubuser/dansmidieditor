        ...
        if direction == '+':
            if '0' <= key <= '9':
                ...
                action = {
                    ...
                    'q': lambda: self.editor.staves_add(-self.take_reps()),
                    'a': lambda: self.editor.staves_add(self.take_reps()),
                    'Q': lambda: self.editor.multistaffing_add(-self.take_reps()),
                    'A': lambda: self.editor.multistaffing_add(self.take_reps()),
                    'z': lambda: self.editor.duration_add(-self.take_reps()),
                    'x': lambda: self.editor.duration_add(self.take_reps()),
